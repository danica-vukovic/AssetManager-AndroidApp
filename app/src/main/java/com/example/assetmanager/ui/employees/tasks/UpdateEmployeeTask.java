...
public class UpdateEmployeeTask extends AsyncTask<Void, Void, Boolean> {
    private final WeakReference<EmployeesFragment> fragmentWeakReference;
    private final Employee employee;

    public UpdateEmployeeTask(EmployeesFragment fragment, Employee employee) {
    ...
    protected Boolean doInBackground(Void... voids) {
        ...
        if (fragment != null && employee != null) {
            try {
                ...
                Log.e("UpdateEmployeeTask", "Error updating employee", e);
            }
        }
        return result;
    }
    ...
    protected void onPostExecute(Boolean success) {
        ...
        if (fragment != null) {
            if (success) {
                Toast.makeText(fragment.getContext(), R.string.employee_updated_successfully, Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(fragment.getContext(), R.string.failed_to_update_employee, Toast.LENGTH_SHORT).show();
            }
